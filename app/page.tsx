...
import { Book, CalendarCheck, MessageSquare, Check, Star } from "lucide-react"
        ...
        <div className="container">
          <div className="mx-auto grid max-w-6xl gap-10 lg:grid-cols-2">
            <ScrollReveal className="flex flex-col justify-center space-y-6">
              <Badge className="h-8 px-5 py-1.5 text-sm">
                <Star className="mr-1 h-3.5 w-3.5" />
                Trusted by over 25 schools
              </Badge>
              <h1 className="text-3xl font-bold leading-[1.25] tracking-tighter text-foreground md:text-4xl lg:text-5xl line-clamp-3 pb-1.5">
                AI-Powered Learning That Adapts to <span className="text-primary">Every</span> Student
              </h1>
              <p className="text-xl font-medium text-primary/90 mt-2 mb-6">
              ...
              <div className="flex flex-col gap-3 sm:flex-row">
                <Button asChild size="lg" className="h-12 px-6">
                  <Link href="/features">See PULSE in Action</Link>
                </Button>
                <ScheduleDemoForm />
              </div>
              <div className="mt-6 space-y-2">
                <div className="flex items-start">
                  <Check className="mr-2 h-5 w-5 shrink-0 text-primary mt-0.5" />
                  <span className="text-sm">AI-Powered Learning – Adapts to each student's strengths & challenges</span>
                </div>
                <div className="flex items-start">
                  <Check className="mr-2 h-5 w-5 shrink-0 text-primary mt-0.5" />
                  <span className="text-sm">
                    Boosts Academic Performance – Smarter, faster learning, delivering 30% faster mastery of core
                    concepts
                  </span>
                </div>
                <div className="flex items-start">
                    ...
                    <div className="col-span-9 overflow-auto">
                      <div className="p-6">
                        <div className="mb-6">
                          ...
                          <p className="text-muted-foreground">
                            Learn how to solve quadratic equations using Learn how to solve quadratic equations using
                            different methods.
                          </p>
